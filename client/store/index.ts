...
import userProductSlice from "./services/user/userProductSlice";
...
const reducer = (
  ...
  if (action.type === HYDRATE) {
    const nextState = {
      ...
      userProductSlice: {
        loading: state.userProductSlice.loading,
        products: {
          ...action.payload.userProductSlice.products,
          ...state.userProductSlice.products,
        },
      },
    };
    return nextState;
